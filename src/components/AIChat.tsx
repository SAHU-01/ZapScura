...
import { Shield, Send, CheckCircle2, AlertTriangle, Zap, Target } from 'lucide-react';
...
import { recordAction, getAvailableQuests, type XPGainResult, type Quest } from '../lib/gamification';
      ...
      if (result.success) {
        ...
        if (address) {
          ...
          const privacyScore = totalBal > BigInt(0)
            ...
            : 0;
          const xpGain = recordAction(address, action.action, privacyScore);
          setXpResult(xpGain);
        }
      }
  ...
  return (
    <div style={{
      ...
      <div className="zap-chat-messages">
        {messages.length === 0 && (() => {
          const quests = address ? getAvailableQuests(address) : [];
          const diffColors = { starter: '#10b981', intermediate: '#f59e0b', advanced: '#ef4444' };
          return (
          <div style={{ textAlign: 'center', padding: '40px 20px' }}>
            ...
            <p style={{
              ...
              Complete quests to earn XP, level up, and unlock achievements. Your privacy journey starts now.
            </p>
              ...
              <div style={{ maxWidth: 500, margin: '0 auto 16px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {quests.map((quest: Quest) => (
                    <button
                      key={quest.id}
                      onClick={() => handleSend(quest.action)}
                      style={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: 12,
                      ...
                      className="zap-quest-btn"
                    >
                      <GamificationIcon name={quest.icon} size={18} color="#8b5cf6" />
                      <div style={{ flex: 1 }}>
                        <div style={{
                          fontFamily: "'Orbitron', sans-serif",
                          fontSize: 11,
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
                        ...
                        <span style={{
                          ...
                          textTransform: 'uppercase',
                          padding: '1px 6px',
                          background: `${diffColors[quest.difficulty]}15`,
                          border: `1px solid ${diffColors[quest.difficulty]}30`,
